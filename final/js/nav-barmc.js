...
//this is the mycart.html navbar
const createNav = () => {
...
<nav>
    <ul>
      ...
      <li><a href="myreservations.html" class="active">My Reservations</a></li>  <!--the my cart page  has the class active which changes the background
