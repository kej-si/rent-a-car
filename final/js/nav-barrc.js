...
//this is the rentacar.html navbar
const createNav = () => {
...
<nav>
    <ul>
      ...
      <li><a href="rentacar.html" class="active">Rent a Car</a></li>   <!--the rent a car page  has the class active which changes the background
